...
import { createKeyword as writeKeyword, readKeywords as getKeywords, readKeyword as getKeyword, deleteKeyword, chooseKeyword as chooseActiveKeyword, } from '../services/repositories/keyword.service.js';
...
export async function readKeywords(req, res, next) {
    try {
        const id = req.userId;
        if (!id) {
            throw HttpError(401, 'Unauthorized');
...
export async function deleteKeywordById(req, res, next) {
    try {
        const id = req.userId;
...
export async function chooseKeyword(req, res, next) {
    try {
        const id = req.userId;
