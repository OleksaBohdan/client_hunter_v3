...
import { deleteBlackIndustry, readBlackIndustries as getBlackIndustries, createBlackIndustry as writeBlackIndustry, } from '../services/repositories/blackIndustry.service.js';
export async function createBlackIndustry(req, res, next) {
    try {
        const id = req.userId;
...
export async function readBlackIndustries(req, res, next) {
    try {
        const id = req.userId;
        if (!id) {
            throw HttpError(401, 'Unauthorized');
...
export async function deleteBlackIndustryById(req, res, next) {
    try {
        const id = req.userId;
...
//# sourceMappingURL=blackIndustry.controller.js.map