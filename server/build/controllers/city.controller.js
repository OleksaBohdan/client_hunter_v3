...
import { createCity as writeCity, readCities as getCities, readCity as getCity, deleteCity, chooseCity as chooseActiveCity, } from '../services/repositories/city.service.js';
...
export async function readCities(req, res, next) {
    try {
        const id = req.userId;
        if (!id) {
            throw HttpError(401, 'Unauthorized');
...
export async function chooseCity(req, res, next) {
    try {
        const id = req.userId;
